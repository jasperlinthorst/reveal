...
def main():
    ...
    parser_transform.add_argument("--structonly", dest="allcontigs", action="store_false", default=False, help="Only output paths for contigs that contain structural rearrangements.")
