...
def main():
    ...
    parser_transform.add_argument("-m", dest="minlength", type=int, default=0, help="Min length of maximal exact matches for considering (if set to 0, try to extract all MUMs).")
