...
def main():
    ...
    parser_finish.add_argument("--maxn", dest="maxn", type=int, default=20000, help="Max number of MUMs to consider for chaining.")
    ...
    parser_inversions.add_argument("--nofilter", dest="filtercontained", action="store_false", default=True, help="Also use matches that are contained within matches that originate from the reverse complement.")
