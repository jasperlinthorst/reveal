...
def main():
    ...
    parser_refine.add_argument("--mindiff", dest="mindiff", default=0, type=int, help="Only refine variants where the difference between the min- and max-allele size is larger than this many bp.")
