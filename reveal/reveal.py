...
def main():
    ...
    parser_realign.add_argument("--minsize", dest="minsize", default=None, help="When using --all or --complex only realign bubbles for which the smallest allele has at least this many basepairs (if not specified use value of -m).")
