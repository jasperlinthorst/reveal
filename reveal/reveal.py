...
def main():
    ...
    parser_aln.add_argument("--maxmums", dest="maxmums", type=int, default=0, help="Number of largest MUMs to consider for chaining (when 0 use all).")
    ...
    parser_realign.add_argument("-n", dest="minn", type=int, default=None, help="Only align graph on exact matches that occur in at least this many samples.")
    ...
    parser_realign.add_argument("--maxmums", dest="maxmums", type=int, default=0, help="Number of largest MUMs to consider for chaining (when 0 use all).")
